      ...
      <div className="container px-4 md:px-6 mx-auto">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
          <div className="space-y-4">
            ...
            <p className="text-sm text-muted-foreground">
              The global agricultural social platform connecting farmers, buyers, and experts worldwide.
            </p>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link href="/ai-tools" className="text-muted-foreground hover:text-primary">
                  AI Tools
                </Link>
              </li>
              <li>
                <Link href="/weather" className="text-muted-foreground hover:text-primary">
                  Weather Insights
                </Link>
              </li>
            </ul>
        ...
        <div className="mt-12 pt-8 border-t flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm text-muted-foreground mb-4 md:mb-0">
            © 2025 AgroByte. All rights reserved.
          </p>
